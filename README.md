...
| `update-release` | Update an existing box to an **official tagged release** (e.g. `0.1.10-alpha`) — checkout the tag, rebuild the host daemon/CLI/LA on the box, restart, and pull the matching GHCR env image. |
